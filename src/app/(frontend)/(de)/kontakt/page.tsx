        ...
        <div className="grid md:grid-cols-2 gap-10 md:gap-0 md:mt-10">
          ...
          <div className="flex flex-col sm:px-8 py-10  text-sm xl:text-base">
            ...
            <div className=" space-y-4 pb-4 flex flex-col text-muted-foreground">
              <div>
                <p className="font-semibold text-blue-900 mb-2">Adresse</p>
              ...
              <div className="">
                <p className="font-semibold text-blue-900 mb-2">Telefon</p>
            ...
            <div>
              <p className="font-semibold text-blue-900 my-2">Soziale Medien</p>
