...
const ProjectDetailPage = async ({ params }: { params: Promise<{ projectId: string }> }) => {
  ...
  const project = await fetchById<Project>('projects', projectId, { locale: 'de' })
      ...
      <div className="mx-auto md:pt-4 lg:pt-6 pb-12">
        <div className="flex flex-col 2xl:flex-row gap-10">
          ...
          <div className="w-full 2xl:w-1/3">
            <h2 className="text-xl font-bold text-priColor mb-2">Projektübersicht</h2>
          ...
          <div className="w-full 2xl:w-2/3  overflow-hidden rounded-md">
            ...
            <section className="mb-10 w-full">
              <h2 className="text-xl font-bold text-priColor mb-4">Projektgalerie</h2>
